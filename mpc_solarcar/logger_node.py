...
class LoggerNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Float32, '/vehicle/speed_kmh', self._set('speed_kmh'), 10)
        self.create_subscription(Float32, '/vehicle/s_km', self._set('s_km'), 10)
        self.create_subscription(Float32, '/vehicle/rpm', self._set('rpm'), 10)
        self.create_subscription(Float32, '/vehicle/throttle_pct', self._set('throttle_pct'), 10)
        self.create_subscription(Float32, '/vehicle/maf_gps', self._set('maf_gps'), 10)
        self.create_subscription(Float32, '/vehicle/fuel_rate_lph', self._set('fuel_rate_lph'), 10)
        self.create_subscription(Float32, '/vehicle/obd_ok', self._set('obd_ok'), 10)
        self.create_subscription(Float32, '/vehicle/idle_fuel_lph', self._set('idle_fuel_lph'), 10)
        self.create_subscription(Float32, '/vehicle/grade', self._set('grade'), 10)
        self.create_subscription(Float32, '/vehicle/batt_soc', self._set('batt_soc'), 10)
        self.create_subscription(Float32, '/vehicle/batt_temp_c', self._set('batt_temp_c'), 10)
        self.create_subscription(Float32, '/vehicle/batt_current_a', self._set('batt_current_a'), 10)
        self.create_subscription(Float32, '/vehicle/batt_voltage_v', self._set('batt_voltage_v'), 10)
        self.create_subscription(Float32, '/planner/speed_cmd', self._set('speed_cmd'), 10)
        self.create_subscription(Float32, '/planner/upper_speed_cmd', self._set('upper_speed_cmd'), 10)
        self.create_subscription(Float32, '/planner/throttle_cmd_pct', self._set('throttle_cmd_pct'), 10)
        self.create_subscription(String, '/planner/drive_mode', self._set_str('drive_mode'), 10)
        ...
        self.create_subscription(Float32, '/system/health', self._set('system_health'), 10)
        self.create_subscription(String, '/system/state', self._set_str('system_state'), 10)
        self.create_subscription(String, '/system/diag', self._set_str('system_diag'), 10)
        self.create_subscription(String, '/system/can_profile', self._set_str('can_profile'), 10)
        self.create_subscription(String, '/system/pid_profile', self._set_str('pid_profile'), 10)
        self.create_subscription(String, '/system/mpc_state', self._set_str('mpc_state'), 10)
        self.create_subscription(String, '/system/config', self._set_str('config_yaml'), 10)
        self.create_subscription(String, '/system/forecast_status', self._set_str('forecast_status'), 10)
        self.create_subscription(String, '/system/calibration_status', self._set_str('calibration_status'), 10)
        self.create_subscription(String, '/system/command_status', self._set_str('command_status'), 10)
        self.create_subscription(String, '/system/network_status', self._set_str('network_status'), 10)
        self.create_subscription(String, '/system/wind_model_status', self._set_str('wind_model_status'), 10)
        self.create_subscription(Float32, '/vehicle/headwind_obs_ms', self._set('vehicle_headwind_obs_ms'), 10)
        self.create_subscription(Float32, '/chase/headwind_obs_ms', self._set('chase_headwind_obs_ms'), 10)
