\documentclass[a4paper,11pt]{article}
        ...
        ソースSHA-256 & \path|5b7604b18712958285819b64c5a5dcd7b3206c77f32136a4ac97e3a43263476f| \\
...
\end{itemize}
        ...
        \subsection{L10 関数 \_setup}
            \begin{itemize}[leftmargin=1.6em]
              ...
              \item 主なローカル代入名: cfg, profile\_path, profile\_yaml
...
\subsection{L16 関数 generate\_launch\_description}
            \begin{itemize}[leftmargin=1.6em]
              \item 行範囲: L16--L22
              \item 所属: module直下
