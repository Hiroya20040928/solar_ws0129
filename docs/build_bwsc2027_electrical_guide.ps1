...
$Source = Join-Path $DocsDir 'bwsc2027_electrical_development_complete_guide.md'
$PdfOut = Join-Path $DocsDir 'bwsc2027_electrical_development_complete_guide.pdf'
$DocxOut = Join-Path $DocsDir 'bwsc2027_electrical_development_complete_guide.docx'
$PreviewDir = Join-Path $DocsDir 'pdf_check_electrical_guide'
...
try {
    python (Join-Path $DocsDir 'generate_bwsc2027_electrical_assets.py')
