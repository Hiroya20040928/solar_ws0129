...
- `mpc_solarcar/route_utils.py` - MLE/re-identification, ROS and simulation, multi-fidelity CEM and exact acceptance, package, blank, audit, regression tests
...
- `mpc_solarcar/model.py` - MLE/re-identification, ROS and simulation, package, blank, audit, regression tests
- `mpc_solarcar/route_utils.py` - MLE/re-identification, ROS and simulation, multi-fidelity CEM and exact acceptance, package, blank, audit, regression tests
- `mpc_solarcar/schedule_utils.py` - CPU self-learning, MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/signal_utils.py` - MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/solar_profile.py` - MLE/re-identification, ROS and simulation, basic identification, regression tests, sim/measure/live/live_wifi
- `mpc_solarcar/upper_cost.py` - CPU self-learning, MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/upper_horizon.py` - MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/upper_solver.py` - MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/utils_maps.py` - MLE/re-identification, package, blank, audit, regression tests
...
- `mpc_solarcar/upper_horizon.py` - MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/upper_solver.py` - MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/weather_utils.py` - ROS and simulation, regression tests
- `scripts/bootstrap_ubuntu_humble.sh` - ROS and simulation, install and dispatch
...
- `mpc_solarcar/dashboard_node.py` - regression tests, sim/measure/live/live_wifi
- `mpc_solarcar/forecast_grid.py` - regression tests
- `mpc_solarcar/model.py` - MLE/re-identification, ROS and simulation, package, blank, audit, regression tests
- `mpc_solarcar/route_utils.py` - MLE/re-identification, ROS and simulation, multi-fidelity CEM and exact acceptance, package, blank, audit, regression tests
- `mpc_solarcar/schedule_utils.py` - CPU self-learning, MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/signal_utils.py` - MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/solar_autocal_logic.py` - regression tests
- `mpc_solarcar/solar_preflight_logic.py` - regression tests
- `mpc_solarcar/solar_profile.py` - MLE/re-identification, ROS and simulation, basic identification, regression tests, sim/measure/live/live_wifi
- `mpc_solarcar/telemetry_protocol.py` - regression tests
- `mpc_solarcar/upper_cost.py` - CPU self-learning, MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/upper_horizon.py` - MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/upper_policy.py` - regression tests
- `mpc_solarcar/upper_solver.py` - MLE/re-identification, ROS and simulation, regression tests
- `mpc_solarcar/utils_maps.py` - MLE/re-identification, package, blank, audit, regression tests
- `mpc_solarcar/weather_utils.py` - ROS and simulation, regression tests
- `scripts/assess_terminal_soc_consistency.py` - MLE/re-identification, regression tests
